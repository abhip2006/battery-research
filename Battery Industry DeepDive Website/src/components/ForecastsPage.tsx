    ...
    <div className="min-h-screen pt-24 bg-[#0A0A0A]">
      ...
      <div className="relative bg-[#0F0F0F] border-b-4 border-[#B2FF59] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          >
            <h1 className="text-[#B2FF59] mb-4 text-5xl font-extrabold font-tech uppercase tracking-wider">Market Forecasts</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-12">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="text-[#B2FF59] mb-6 text-3xl font-bold font-tech uppercase tracking-wider">Forecast Scenarios</h2>
          <div className="grid grid-cols-3 gap-6">
            {SCENARIOS.map((scenario, index) => (
              <motion.div
                ...
                className="bg-[#1A1A1A] p-6 rounded-xl border-2 border-[#2B2B2B] hover:border-[#B2FF59] hover:shadow-lg hover:shadow-[#B2FF59]/20 transition-all duration-300"
              >
                <h3 className="text-[#FAFAFA] mb-3 text-xl font-bold">{scenario.name}</h3>
                <p className="text-[#CCCCCC] text-sm mb-6 leading-relaxed">{scenario.description}</p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="text-[#B2FF59] mb-6">Capacity & Production Outlook</h2>
                ...
                <div className="mt-6 flex justify-between items-center">
                  <div className="flex gap-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[#FAFAFA]/70 text-sm">Manufacturing Capacity</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-4 h-0.5 bg-[#1565C0]" />
                      <span className="text-[#FAFAFA]/70 text-sm">Actual Production</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-4 h-0.5 bg-[#FFB300] opacity-50" />
                      <span className="text-[#FAFAFA]/70 text-sm">Projected Demand</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex gap-6">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#FAFAFA]/70 text-sm">2030 Demand</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-4 h-4 bg-[#B2FF59]" />
                        <span className="text-[#FAFAFA]/70 text-sm">Projected Supply</span>
                      </div>
                    </div>
                  </div>
        ...
        >
          <div className="bg-[#1E1E1E] p-6 rounded-xl border border-[#B2FF59]/20">
            ...
            <div className="text-[#FAFAFA] font-mono mb-1">5.1x</div>
          ...
          <div className="bg-[#1E1E1E] p-6 rounded-xl border border-[#1565C0]/20">
            <TrendingUp className="size-8 text-[#1565C0] mb-3" />
            <div className="text-[#FAFAFA] font-mono mb-1">-50%</div>
            <div className="text-[#FAFAFA]/70 text-sm">Cost Reduction by 2030</div>
          </div>
          <div className="bg-[#1E1E1E] p-6 rounded-xl border border-[#FFB300]/20">
            <AlertCircle className="size-8 text-[#FFB300] mb-3" />
            <div className="text-[#FAFAFA] font-mono mb-1">2</div>
